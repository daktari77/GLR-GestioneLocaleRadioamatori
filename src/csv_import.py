...
AUTO_GUESS = {
    ...
    "data_iscrizione": {"iscrizione", "data_iscrizione", "join_date", "membership_date", "data di iscrizione"},
    "data_scadenza": {"scadenza", "data_scadenza", "expiry", "expiration", "expire_date", "data di scadenza"},
